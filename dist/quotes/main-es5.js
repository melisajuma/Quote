...
var HighlightDirective = /** @class */ (function () {
    ...
    HighlightDirective.prototype.highlightElement = function () {
...
var QuoteDetailsComponent = /** @class */ (function () {
    ...
    QuoteDetailsComponent.prototype.highQuote = function () {
...
var Quote = /** @class */ (function () {
    function Quote(id, description, name, publisher, completeDate, upvote, downvote) {
        this.id = id;
...
module.exports = "@import url('https://fonts.googleapis.com/css?family=Black+And+White+Picture&display=swap');\n@import url(\"https://fonts.googleapis.com/css?family=Black+And+White+Picture|Yesteryear&display=swap\");\n@import url('https://fonts.googleapis.com/css?family=Indie+Flower&display=swap');\nnav{\n    color: white;\n    font-family:'Indie Flower', cursive;\n    margin-bottom:5%;\n}\nnav img{\n    color: #fff;\n}\nfooter{\n    color: #fff;\n    font-size: 20px;\n    font-family: 'Indie Flower', cursive;\n}\n#con-1{\n    background-color:rgba(26, 27, 26, 0.685);\n    margin-top: 5%;\n    font-family:'Indie Flower', cursive;\n    color: #fff;\n    font-weight: 280;\n    font-size: 20px;\n}\nnav img{\n    font-family: 'Indie Flower', cursive;\n}\n@media only screen and (max:width= 450px){\n    #con-1{\n        width: 100%;\n    }\n}\n#like, #unlike, #delete{\n    padding: 5%;\n    color: white;\n}\n#del{\n    padding-top: 3%;\n    margin-left: 7%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var QuoteComponent = /** @class */ (function () {
    ...
    QuoteComponent.prototype.deleteQuote = function (isComplete, index) {
        if (isComplete) {
            var toDelete = confirm('Do you really want  to delete this quote?');
            if (toDelete) {
    ...
    QuoteComponent.prototype.like = function (index) {
        this.quotes[index].upvote += 1;
        // console.log(1);
    };
    QuoteComponent.prototype.unlike = function (index) {
